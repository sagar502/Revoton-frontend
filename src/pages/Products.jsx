...
const H13 = {
  name: "H13 ",
  title: "H13 | 1.2344 | X40CrMoV5-1 — Hot Work Tool Steel",
  description:
...
const H11 = {
  name: "H11",
  title: "H11 | 1.2343 | X37CrMoV5-1 — Hot Work Tool Steel",
  description:
...
const H10 = {
  name: "H10",
  title: "H10 | 1.2365 | X32CrMoV3-3 — Hot Work Tool Steel",
  description:
...
const H12 = {
  name: "H12",
  title: "H12 | 1.2606 | X37CrMoW5-1 — Hot Work Tool Steel",
  description:
...
const S7 = {
  name: "S7 ",
  title: "S7 | 1.2355 | 45CrMoV7 — Shock Resistant Tool Steel",
  description:
...
const A2 = {
  name: "A2 ",
  title: "A2 | 1.2363 | X100CrMoV5 — Cold Work Tool Steel",
  description:
...
const D2 = {
  name: "D2",
  title: "D2 | 1.2379 | X153CrMoV12-1 — Cold Work Tool Steel",
  description:
...
const D3 = {
  name: "D3",
  title: "D3 | 1.2080 | X210Cr12 — Cold Work Tool Steel",
  description:
...
const O1 = {
  name: "O1",
  title: "O1 | 1.2510 | 100MnCrW4 — Cold Work Tool Steel",
  description:
...
const L6 = {
  name: "L6",
  title: "L6 | 1.2714 | 55NiCrMoV7 — Shock Resistant Tool Steel",
  description:
...
const Steel4140 = {
  name: "4140 ",
  title: "AISI 4140 | 42CrMo4 | EN19 — Engineering Alloy Steel",
  description:
...
const Steel5140 = {
  name: "5140 ",
  title: "AISI 5140 | EN47 | 41Cr4 — Spring Alloy Steel",
  description:
...
const Steel4340 = {
  name: "4340 ",
  title: "AISI 4340 | EN24 | 34CrNiMo6 — High Strength Alloy Steel",
  description:
...
const Steel34CrNiMo6 = {
  name: "34CrNiMo6",
  title: "34CrNiMo6 | 1.6582 | EN24 — High Strength Alloy Steel",
  description:
...
const Steel18CrNiMo76 = {
  name: "18CrNiMo7-6 ",
  title: "18CrNiMo7-6 | 1.6587 — Case Hardening Alloy Steel",
  description:
...
const Steel30CrNiMo8 = {
  name: "30CrNiMo8",
  title: "30CrNiMo8 | 1.6580 — High Strength Alloy Steel",
...
const NM400 = {
  name: "NM400 ",
  title: "NM400 — Abrasion Resistant Steel",
...
const P20Ni = {
  name: "P20+Ni ",
  title: "P20+Ni | 1.2738 — Plastic Mold Steel",
...
const S136 = {
  name: "S136 ",
  title: "S136 — Stainless Plastic Mold Steel",
...
const M2 = {
  name: "M2",
  title: "M2 | 1.3343 | HS6-5-2 — High Speed Steel",
...
const M35 = {
  name: "M35",
  title: "M35 | 1.3243 | HS6-5-2-5 | SKH55 — Cobalt HSS",
...
const Steel420 = {
  name: "420 ",
  title: "420 | 1.4021 | X20Cr13 — Martensitic Stainless Steel",
...
const Steel420FM = {
  name: "420FM ",
  title: "420FM | 1.2085 — Free Machining Stainless",
...
const Steel422 = {
  name: "422",
  title: "422 | Heat Resistant Steel",
...
const Steel8620 = {
  name: "8620 ",
  title: "8620 | Case Hardening Steel",
...
const NM500 = {
  name: "NM500 ",
  title: "NM500 — Abrasion Resistant Steel",
...
const P20S = {
  name: "P20S ",
  title: "P20S — Free Machining Mold Steel",
...
const M42 = {
  name: "M42 ",
  title: "M42 | 1.3247 | HS2-9-1-8 | SKH59 — Super Cobalt HSS",
...
export default function GradesPage() {
  ...
  return (
    <Layout>
      <div
        className="bg-[#f5f7f8] min-h-screen pt-48 pb-20 px-6 md:px-20"
      ...
      >
        ...
        <AnimatePresence>
          {selected && (
            <motion.div
              className="fixed inset-0 bg-black/70 backdrop-blur-sm flex justify-center items-start pt-24 z-50 overflow-y-auto"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
            >
              ...
              >
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <Box title="International Standards" />
                  <Box title="Chemical Composition" />
                  <Box title="Mechanical Properties" />
                  <Box title="Physical Properties" />
                  <Box title="Heat Treatment" />
...
function Box({ title }) {
  return (
    <div className="bg-gray-50 p-5 rounded-xl border">
      <h3 className="font-semibold text-[#134e4a] mb-3">
        {title}
      </h3>
